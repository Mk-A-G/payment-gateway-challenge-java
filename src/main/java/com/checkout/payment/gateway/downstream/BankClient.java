 ...
 * bank's payment endpoint. All connectivity and server-side errors are caught and rethrown as
 * {@link BankingSystemUnavailableException} to decouple the rest of the application from Spring's
...
public class BankClient {
   ...
   * @throws BankingSystemUnavailableException if the bank is unreachable or returns a server error
   *                                           response
   */
